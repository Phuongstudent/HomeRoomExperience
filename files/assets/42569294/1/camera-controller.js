...
CameraController.prototype.initialize = function() {
    ...
    this.app.on('cameracontroller:adjustcameraheight', this.AdjustHeight, this);
    this.app.on('cameracontroller:adjustbackcameraheight', this.AdjustBackHeight, this);
    
};

CameraController.prototype.AdjustHeight = function(position) {
    this.entity.translate(0, 1, 0);
};

CameraController.prototype.AdjustBackHeight = function(position) {
    this.entity.rigidbody.teleport(0.381,-0.168,-0.293);
    this.camera.setLocalPosition(0,0.168,0.002);
};
